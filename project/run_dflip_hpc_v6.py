"""HPC dflip launcher for v6 mask-L1. Mirrors run_dflip_hpc.py, Stage2 -> v6.
Produces results/dflip_persample.csv + dflip_panels/*.npz (generic) — pull to *_v6
(会话 20/21 convention). Stage2 is positional [1] so key string is cosmetic. cwd=code/."""
import sys
sys.path.insert(0, ".")
