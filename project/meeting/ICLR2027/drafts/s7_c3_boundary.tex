...
null: melanoma salvage stays at $5.2\%$ ($4/77$, unchanged from the feature-DP model) while damage
moves only marginally to $30.3\%$ ($83/274$), for a net of $-79$ malignant cases --- statistically
...
three quality bands: $0.055$ on the high band ($95\%$ CI $[0.031,0.083]$), $0.651$ on the moderate
band ($[0.600,0.705]$), and $0.889$ on the severe band ($[0.800,0.978]$; bootstrap CIs, all
non-overlapping).% \todo{verifier: re-check retake-fraction CIs migrated from main.tex L441-442 against results source before merge}
