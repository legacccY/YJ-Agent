...
\todo{fig:c0-surface}; we summarise the two axes below.

\paragraph{Reliability axis.}
Diagnostic AUC degrades monotonically, or near-monotonically, with severity
along every dimension, but the magnitude differs sharply by corruption type.
...
enhancer of \cref{sec:method-enhance} is designed to exploit), but at least one
...
that drives the safety boundary in \cref{sec:exp-salvage} (E5/E6, reported by
