...
rather than pooled away, and \cref{sec:exp-cross} additionally evaluates zero-shot transfer to four
external dermatology datasets that progressively depart from the training distribution --- including
PAD-UFES-20 clinical smartphone macro photography and Fitzpatrick17k in-the-wild clinical photographs
carrying real shadows, lens artefacts, and compression --- and we report the resulting calibration
and discrimination erosion with domain distance rather than averaging it away. (Evaluation on a
dedicated in-the-wild smartphone subset, e.g.\ ISIC~2024 SLICE-3D, is left to future work and is
not claimed here.) (ii) Cross-modality
