...
calibration error, $\delta_{\TV}\approx\ECE$;%
\todo{verifier: insert the numeric ECE value for the routing predictor from its calibration csv once frozen; do not print a value from memory.}
