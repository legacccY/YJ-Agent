...
policy, which (Remark~\ref{rem:no-global}) is not observed empirically. Realising the band-local
gain as a global utility improvement would require learning the routing thresholds rather than
fixing them by grid search, which we leave to future work.
\end{corollary}
