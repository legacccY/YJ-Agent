...
To respect the nine-page main-text limit, two result figures referenced
in the main text are reproduced here in full resolution: the reliability\,$\times$\,recoverability
decision surface of \cref{sec:decision-surface} and the enhancement-versus-restoration comparison of
\cref{sec:exp-sota}. The E10 generic-restoration table (\cref{tab:e10}) now lives in the main text
(\cref{sec:exp-sota}) as the SOTA-comparison centrepiece. The accompanying numbers
