...
leave the diagnostic posterior intact, and it is the term whose ablation (E7,
\cref{sec:exp}) attributes the diagnosis-preserving effect to the design rather than to
restoration capacity. Training minimises
\begin{equation}
