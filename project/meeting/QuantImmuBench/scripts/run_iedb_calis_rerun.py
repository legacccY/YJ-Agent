...
BACKBONE = ROOT / "scripts" / "out_rerun" / "master_backbone_official.csv"
TOOL = ROOT / "HPC" / "deploy" / "iedb_calis" / "immunogenicity" / "predict_immunogenicity.py"
WORKDIR = ROOT / "scripts" / "out_rerun_official" / "iedb_calis_work"  # per-allele 临时 in/out
OUT = ROOT / "scripts" / "out_rerun_official" / "IEDB_Calis_official.csv"
